    ...
    return (
        <div className="sticky w-full top-0 left-0 bg-white z-10 border-b-2 border-amber-500">
            <div className="container mx-auto flex justify-between items-center px-6 py-4">
                {/* Logo */}
                <div id="logo">
                    <img src="/assets/logo-black.png" alt="logo" className="w-16 h-8" />
                </div>
            ...
            <div className={`md:hidden bg-amber-600/90 w-full absolute top-16 left-0 transition-all duration-700 ease-in-out ${menuOpen ? "block" : "hidden"}`}>
